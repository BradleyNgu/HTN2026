  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Pressable onPress={() => router.push("/incoming-call")} style={styles.alertRow}><Text style={styles.alertIcon}>♧</Text><Text style={styles.alertText}>Test escape call</Text><Text style={styles.chevron}>›</Text></Pressable>
